...
function skt_photo_world_scripts() {
	...
	wp_enqueue_style( 'skt-photo-world-supersized-style', get_template_directory_uri()."/css/supersized.shutter.css" );
	
	wp_enqueue_script( 'skt-photo-world-supersized-slider', get_template_directory_uri() . '/js/supersized.3.2.7.min.js', array('jquery') );

	wp_enqueue_script( 'skt-photo-world-supersized-shutter', get_template_directory_uri() . '/js/supersized.shutter.js', array('jquery') );
		
	wp_enqueue_script( 'skt-photo-world-shutter-min', get_template_directory_uri() . '/theme/supersized.shutter.min.js', array('jquery') );
	
	wp_enqueue_script( 'skt-photo-world-shutter', get_template_directory_uri() . '/theme/supersized.shutter.js', array('jquery') );
