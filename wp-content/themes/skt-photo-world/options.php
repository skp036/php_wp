...
function optionsframework_options() {
	...
	$options[] = array(
		...
		'id' => 'footertext2',
		'std' => 'Photo World 2015. All Rights Reserved',
		'type' => 'text');
	...
	$options[] = array(
	 ...
	 $options[] = array(
		'desc' => __('<a href="'.esc_url(SKT_THEME_URL).'"><img src="'.get_template_directory_uri().'/images/sktskill.jpg"></a><p><em><a target="_blank" href="'.esc_url(SKT_THEME_URL_DIRECT).'">Buy PRO version for only $39 with more features.</a></em></p>', 'skt-photo-world'),
		'type' => 'info');	
